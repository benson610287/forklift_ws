...
// Create a ROS logger
auto const logger = rclcpp::get_logger("ptop_goal");
...
int main(int argc, char * argv[])
{
  ...
  node = std::make_shared<rclcpp::Node>("ptop_goal");
  ...
  rclcpp::Service<interface::srv::Armcontrol>::SharedPtr service = node->create_service<interface::srv::Armcontrol>("ptop_arm_cmd", &add);
