...
##先去RIVZ2使用Publish Point工具 滑鼠指向地圖上的點位，x,y座標會顯示在左下角，找到目標點位之x,y座標後yam之角度直接目測，面向研究生座位區，與場地周圍平行為0度，貨架方向為90度，以此類推
```bash
...
---
範例程式 
/home/flash/forkliftslam_ws/src/timda_slam/timda_slam/test_goal_publisher.py
```bash
ros2 run timda_slam test_goal_publisher
